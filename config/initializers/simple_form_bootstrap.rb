...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'row' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :custom_boolean, tag: 'fieldset' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :custom_boolean_switch, tag: 'fieldset' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :custom_collection_inline, item_wrapper_class: 'custom-control custom-control-inline', item_label_class: 'custom-control-label', tag: 'fieldset' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
  ...
  # custom range input
  config.wrappers :custom_range, tag: 'div' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  # config.wrappers :input_group, tag: 'div' do |b|
  #   b.use :html5
  #   b.use :placeholder
  #   b.optional :maxlength
  #   b.optional :minlength
